    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className='max-h-[90vh] flex flex-col'>
        ...
        <div className='flex items-center space-x-2 mb-3'>
          ...
          <Switch id='airplane-mode' checked={isNewCustomer} onCheckedChange={setIsNewCustomer} />
        </div>
        {!isNewCustomer && (
          <>
            <Form {...form}>
          ...
          <Form {...form}>
            <form>
              <div className='grid grid-cols-6 gap-2 items-center'>
                ...
                <div className='col-span-4'>
                  <InputCustom control={form.control} name='customerName' placeholder='Nhập tên khách hàng' />
                </div>
              </div>
              <div className='grid grid-cols-6 gap-2 items-center'>
                <div className='col-span-2 text-sm'>Số bàn</div>
                <div className='col-span-4'>
                  <InputCustom control={form.control} name='tableNumber' placeholder='Nhập số bàn' />
                </div>
              </div>
            </form>
          </Form>
