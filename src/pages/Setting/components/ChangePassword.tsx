      ...
      <div>
        <Form {...form}>
          <form onSubmit={onSubmit}>
            <InputCustom control={form.control} name='oldPassword' placeholder='Mật khẩu cũ' label='Mật khẩu cũ' />
            <InputCustom control={form.control} name='newPassword' placeholder='Mật khẩu mới' label='Mật khẩu mới' />
            <InputCustom
