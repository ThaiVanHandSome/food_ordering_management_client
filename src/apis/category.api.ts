...
export const createCategory = (body: { name: string }) => http.post<SuccessResponse<string>>('/categories', body)

export const updateCategory = (id: string, body: { name: string }) =>
  http.patch<SuccessResponse<string>>(`/categories/${id}`, body)

export const deleteCategory = (id: string) => http.delete<SuccessResponse<string>>(`/categories/${id}`)
